...
const GROUP_HOUSE_COST = {
  TN: 50, EG: 50, PS: 100, MA: 100, DE: 100, QA: 100,
  JO: 150, SY: 150, AE: 150, GB: 200, SA: 200
};

// ألوان المجموعات
const GROUP_COLOR = {
  TN: '#e74c3c', EG: '#fdf3ae', PS: 'rgba(255,255,255,.82)', MA: '#c1272d', DE: '#ffffff', QA: '#d4af37',
  JO: '#e74c3c', SY: '#007a3d', AE: '#d94f70', GB: '#c9a227', SA: '#0a5c36'
};
...
const BOARD = [
  ...
  { ...city(10, 13, 'Salmiya', 180, 'DE'), flag: '🇰🇼' },
  ...
  { type: 'surprise', r: 13, c: 5, name: 'Surprise', icon: '❓', special: true },
